...
def main() -> int:
    parser = argparse.ArgumentParser(description="Profile representative rdlocrand Stata hot paths.")
    ...
    log_file = profile_dir / "profile-stata-hotpaths.log"
    csv_file = profile_dir / "stata-hotpaths.csv"
    profile_dir.mkdir(parents=True, exist_ok=True)

    do_file = repo_root / "scripts" / "profile-stata-hotpaths.do"
    ...
    if result.returncode != 0 or "Stata hot-path profiling complete." not in log_text:
